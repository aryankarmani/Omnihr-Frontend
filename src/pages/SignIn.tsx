                ...
                <div className="w-full md:w-[54%] lg:w-[52%] p-6 sm:p-10 lg:p-12 flex flex-col justify-between bg-white/95">
                    <div>
                        ...
                        <div className="flex items-center gap-2.5 mb-6 md:hidden">
                            ...
                            <div>
                                <span className="text-xl font-extrabold text-[#12151C]">OmniHR</span>
                        ...
                        <form onSubmit={handleLogin} noValidate className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors pointer-events-none ${
                                        touched.email && errors.email ? 'text-rose-500' : 'text-gray-400 group-focus-within:text-[#2C4FD6]'
                                    }`}>
                                        <Mail size={17} />
                                    </div>
                                    <input
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group">
                                    <div className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors pointer-events-none ${
                                        touched.password && errors.password ? 'text-rose-500' : 'text-gray-400 group-focus-within:text-[#2C4FD6]'
                                    }`}>
                                        <Lock size={17} />
                                    </div>
                                    <input
